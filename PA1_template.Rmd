...
```{r, fig.path="figure/plot1.png",fig.show='asis'}
...
```{r, fig.path="figure/plot2.png",fig.show='asis'}
...
```{r, fig.path="figure/plot3.png",fig.show='asis'}
...
```{r, fig.path="figure/plot4.png",fig.show='asis'}
require("lattice")
